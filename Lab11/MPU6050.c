...
void MPU6050_SetGyroOffestX(uint16_t offset){
	i2c_sendPacket(MPU6050_ADDRESS, MPU6050_RA_XG_OFFS_USRL, 2, (unsigned char*)&offset);
}

void MPU6050_SetGyroOffestY(uint16_t offset){
	i2c_sendPacket(MPU6050_ADDRESS, MPU6050_RA_YG_OFFS_USRL, 2, (unsigned char*)&offset);
}

void MPU6050_SetGyroOffestZ(uint16_t offset){
	i2c_sendPacket(MPU6050_ADDRESS, MPU6050_RA_ZG_OFFS_USRL, 2, (unsigned char*)&offset);
}

void MPU6050_SetAccelOffestX(uint16_t offset){
	i2c_sendPacket(MPU6050_ADDRESS, MPU6050_RA_XG_OFFS_USRL, 2, (unsigned char*)&offset);
}
